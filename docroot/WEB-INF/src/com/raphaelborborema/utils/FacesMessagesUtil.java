...
public class FacesMessagesUtil {
	...
	private static final Logger logger = LoggerFactory.getLogger(FacesMessagesUtil.class);
	...
	public static void addGlobalErrorMessage(String key , String... args) {
		addErrorMessage(FacesContext.getCurrentInstance(), null, key, args);
	}

	public static void addGlobalErrorMessage(String key ) {
		addErrorMessage(FacesContext.getCurrentInstance(), null, key, null);
	}
	...
	public static void addGlobalInfoMessage(String key) {
		addInfoMessage(FacesContext.getCurrentInstance(), null, key, null);
	}
